...
>(({ side = "end", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 flex h-full flex-col bg-background shadow-2xl",
        "focus:outline-none",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
...
const SheetHeader = ({
  ...
  <div
    className={cn("flex shrink-0 flex-col gap-1.5 p-6 pb-4", className)}
    {...props}
  />
);
...
const SheetBody = ({
  ...
  <div
    className={cn("flex-1 overflow-y-auto px-6 pb-6 scrollbar-hide", className)}
    {...props}
  />
);
